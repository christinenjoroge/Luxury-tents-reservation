  ...
  <div class="row">
    ...
    <div class="col-lg-6">
        ...
        <div class="card p-4 mb-3" id="primary-guest">
          ...
          <div class="row g-3">
            ...
            <div class="col-md-6">
              ...
              <input type="text" class="form-control" id="idNumber" placeholder="ID/Passport">
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
              ...
              <input type="tel" class="form-control" id="phone" placeholder="0700123456">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="d-flex gap-3">
        <button class="btn btn-danger" id="completeReservation">Complete Reservation</button>
